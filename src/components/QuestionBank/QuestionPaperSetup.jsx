    ...
    <div style={{ minHeight: "100vh", background: "#f9fafb" }}>
      ...
      <div style={{ background: "#ffffff", borderBottom: "1px solid #e5e7eb" }}>
        ...
        >
          {onBack && (
            <div>
              <Button variant="ghost" onClick={onBack} style={{ padding: "4px 8px", fontSize: 12 }}>
                ← Back
              </Button>
            </div>
          )}
        ...
        <div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                This information will appear in the question paper header.
              </CardDescription>
            </CardHeader>
          ...
          <Card style={{ position: "sticky", top: 24 }}>
            <CardHeader>
              ...
              <CardDescription style={{ fontSize: 11 }}>
                How it will appear on the question paper
              </CardDescription>
            </CardHeader>
            <div
              style={{
            ...
            >
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <p style={{ fontSize: 11, color: "#4b5563", marginTop: 2 }}>
                  Academic Year: {formData.academicYear || "YYYY-YYYY"}
                </p>
              </div>
              <div
                style={{
